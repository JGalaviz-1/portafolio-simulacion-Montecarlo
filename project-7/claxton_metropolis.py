...
w = 900 #number of CLaxton-Benson iterations
K = .15
                                                           #FRECUENTLY USED
...
#this time use the positions at the end of the Metropolis-Montecarlo simulation
coord = np.loadtxt(f"TBU_{N}.txt") #laod the coordinates
...
if N != 10000:
    with open(f"coord_Metro-C_{N}.txt", "w") as f:
        f.write(f"{N}\n")
